...
- Install this extension for fix lagging when the chat is started to lengthy: [Chrome](https://chromewebstore.google.com/detail/chatgpt-lightsession/fmomjhjnmgpknbabfpojgifokaibeoje?hl=en) [Firefox](https://addons.mozilla.org/en-US/firefox/addon/lightsession-for-chatgpt/?utm_source=addons.mozilla.org&utm_medium=referral&utm_content=search)
